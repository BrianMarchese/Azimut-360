  ...
  return (
      ...
      <section id="inicio" className="relative pt-32 pb-20 sm:pb-24 lg:pb-40">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6">
          <div className="max-w-2xl text-white">
            ...
            {/* insignias */}
            <div className="mt-8 flex flex-col sm:flex-row sm:items-center gap-4 pt-4 border-t border-white/15">
      ...
      <div className='relative z-20 max-w-6xl mx-auto -mt-12 sm:-mt-14 px-8 md:px-0'>
        <div className='grid sm:grid-cols-2 lg:grid-cols-4 overflow-hidden rounded-xl bg-white shadow-xl border border-slate-100 '>
            ...
            <div className='flex flex-col items-center justify-center gap-3 px-5 py-6 border-slate-200 sm:border-l sm:border-t-0 '>
